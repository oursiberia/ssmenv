...
ssmenv/0.4.1 darwin-x64 node-v9.11.1
$ ssmenv --help [COMMAND]
USAGE
  $ ssmenv COMMAND
...
...
_See code: [src/commands/env.ts](https://github.com/oursiberia/ssmenv/blob/v0.4.1/src/commands/env.ts)_
...
_See code: [src/commands/env/dotenv.ts](https://github.com/oursiberia/ssmenv/blob/v0.4.1/src/commands/env/dotenv.ts)_
...
_See code: [src/commands/env/list.ts](https://github.com/oursiberia/ssmenv/blob/v0.4.1/src/commands/env/list.ts)_
...
_See code: [src/commands/init.ts](https://github.com/oursiberia/ssmenv/blob/v0.4.1/src/commands/init.ts)_
...
_See code: [src/commands/var.ts](https://github.com/oursiberia/ssmenv/blob/v0.4.1/src/commands/var.ts)_
...
_See code: [src/commands/var/del.ts](https://github.com/oursiberia/ssmenv/blob/v0.4.1/src/commands/var/del.ts)_
...
_See code: [src/commands/var/set.ts](https://github.com/oursiberia/ssmenv/blob/v0.4.1/src/commands/var/set.ts)_
...
_See code: [src/commands/var/tag.ts](https://github.com/oursiberia/ssmenv/blob/v0.4.1/src/commands/var/tag.ts)_
